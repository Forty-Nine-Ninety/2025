...
public class VisionSubsystemCopy extends SubsystemBase{
    ...
    public VisionSubsystemCopy(SwerveSubsystem drivebase,PhotonCamera photonCamera,CommandXboxController joystick){
    ...
    public void update(){
        ...
        */
        ...
        //GET SPEEDS
        //System.out.println("x:"+m_pose.getX()+" ; y:"+m_pose.getY()+" ; z:"+m_pose.getZ()+" ; yaw:"+m_pose.getRotation().getZ()*180/Math.PI);
        if (poseX>1){
        ...
        //System.out.println("angle:"+poseYaw+" "+Math.abs(180-Math.abs(poseYaw)));
        //System.out.println("rotation speed before:"+rotationSpeed);
        ...
        System.out.println("speeds: "+xSpeed+" "+ySpeed+" "+rotationSpeed);
